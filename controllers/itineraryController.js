...
const itineraryController = {
  ...
  returnItinerary: (req, res) => { //find de js es findOne en mongoose
    ...
    createItinerary:(req,res) =>{
      const {itineraryName, userName, userImg, price, likes, duration, hashtags,comments, city} = req.body
      const itinerary = new Itinerary({itineraryName,userName,userImg, price, likes, duration, hashtags,comments, city}).save()
